...
public class ContactsDBController {
    ...
    public Contact createContact(String name, int phoneNumber) {
        ...
        long insertID = database.insert(ContactsDBHelper.CONTACTS_TABLE, null /* only relevant if inserting an empty row.
        ...
        Cursor cursor = database.query(
                ContactsDBHelper.CONTACTS_TABLE /* name of the table */,
    ...
    public void deleteContact(Contact contact) {
        ...
        database.delete(ContactsDBHelper.CONTACTS_TABLE, ContactsDBHelper.COLUMN_ID + " = " + id, null /* whereArgs. same thing like selectionArgs.
